...
/* Todos los objetos, funciones y variables globales de JavaScript se convierten automáticamente en miembros del objeto de ventana */
    ...
    /* creo una validacion, SI data.location es undefined, es decir el nombre del pais no se puede leer (paises con espacio en su nombre) */
    /* se imprimira un mensaje dentro del modal para informar al usuario. */
    /* en caso contrario, se ejecutara el codigo para mostrar el grafico. */
    if (!data.location) {
        document.getElementById('detalleGrafico').innerHTML +=`
        <hr>
        <h2 class="text-center text-white">Error al construir el grafico</h2>
        <hr>
        <h4 class="text-center text-white">
            Por el momento no se pueden graficar los paises que tienen su nombre separado por un espacio y luego otro nombre.
        </h4>
        `;
